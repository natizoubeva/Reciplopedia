...
|                                                 |                                                                           |
|-------------------------------------------------|---------------------------------------------------------------------------|
| **Home Page** - main navigation                 | ![Home Page](Reciplopedia/screenshots/HomePage.png)                       |
| **Adding Eggs** - picked from the search bar    | ![Adding Eggs Search](Reciplopedia/screenshots/AddingEggsInSearchbar.png)              |
| **Adding Eggs** - specifying quantity           | ![Adding Eggs Quantity](Reciplopedia/screenshots/AddingEggsWithQuantity.png)           |
| **Adding Groceries** - saving groceries         | ![Adding Groceries](Reciplopedia/screenshots/AddingGroceries.png)                      |
| **My Ingredients** - current stock              | ![My Ingredients](Reciplopedia/screenshots/MyIngredients.png)                          |
| **My Recipes** - unsorted list                  | ![My Recipes Unsorted](Reciplopedia/screenshots/MyRecipesUnsorted.png)                 |
| **My Recipes** - sorting options                | ![My Recipes Sorting Options](Reciplopedia/screenshots/MyRecipesWithSortingOptions.png) |
| **My Recipes** - sorted by cooking time         | ![My Recipes Sorted](Reciplopedia/screenshots/MyRecipesSortedByCookingTime.png)        |
| **Add New Recipe** - entering a recipe          | ![Add New Recipe](Reciplopedia/screenshots/AddNewRecipe.png)                           |
| **Let's Cook** - recipes you can make right now | ![Let's Cook](Reciplopedia/screenshots/LetsCook.png)                                   |
| **Cook Recipe** - recipe detail view            | ![Cook Recipe](Reciplopedia/screenshots/CookRecipe.png)                                |
